<ul class="p-0 m-0 sidebar-navbar">
    ...
    <li class="nav-item mb-2">
        <a href="{{ route('department.dashboard') }}" class="d-flex align-items-center gap-3
         fw-bold text-decoration-none p-2 ps-4 rounded-pill fs-5
         {{ Route::is('department.dashboard') ? 'active' : '' }}">
            <i class="fa-solid fa-chart-column"></i>
            <span>{{ __('Department Dashboard') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item mb-2">
        <a href="{{ route('department.users') }}" class="d-flex align-items-center gap-3
         fw-bold text-decoration-none p-2 ps-4 rounded-pill fs-5
         {{ Route::is('department.users') ? 'active' : '' }}">
    ...
    <li class="nav-item mb-2">
        <a href="{{ route('department.submissions.index', ['type' => 'paper']) }}" class="d-flex align-items-center gap-3
         fw-bold text-decoration-none p-2 ps-4 rounded-pill fs-5
         {{ request()->routeIs('department.submissions.index') && request('type', 'paper') === 'paper' ? 'active' : '' }}">
            <i class="fa-solid fa-file-lines"></i>
            <span>{{ __('View Papers') }}</span>
        </a>
    </li>
    <li class="nav-item mb-2">
        <a href="{{ route('department.submissions.index', ['type' => 'chapter']) }}" class="d-flex align-items-center gap-3
         fw-bold text-decoration-none p-2 ps-4 rounded-pill fs-5
         {{ request()->routeIs('department.submissions.index') && request('type') === 'chapter' ? 'active' : '' }}">
            <i class="fa-solid fa-file-lines"></i>
    ...
    <li class="nav-item mb-2">
        <a href="{{ route('department.reviews') }}" class="d-flex align-items-center gap-3
         fw-bold text-decoration-none p-2 ps-4 rounded-pill fs-5
         {{ Route::is('department.reviews') ? 'active' : '' }}">
