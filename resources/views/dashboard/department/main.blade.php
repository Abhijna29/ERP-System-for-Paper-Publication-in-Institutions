        ...
        <div class="card card-hover bg-info border-0 shadow-sm text-white">
            <div class="filter position-absolute end-0 me-3 mt-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow shadow">
                    ...
                    <li><a class="dropdown-item" href="{{ route('department.dashboard', ['filter' => 'today']) }}">{{ __('Today') }}</a></li>
                    <li><a class="dropdown-item" href="{{ route('department.dashboard', ['filter' => 'month']) }}">{{ __('This Month') }}</a></li>
                    <li><a class="dropdown-item" href="{{ route('department.dashboard', ['filter' => 'year']) }}">{{ __('This Year') }}</a></li>
                </ul>
            </div>
            <div class="card-body">
