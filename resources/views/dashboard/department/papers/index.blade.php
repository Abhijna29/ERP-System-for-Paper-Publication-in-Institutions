...
<div class="container-fluid mt-5">
    <div class="card bg-white border-0 rounded-4 shadow">
        <div class="card-body user-card">
            ...
            {{-- Filter Section --}}
            <form method="GET" action="{{ route('department.submissions.index', ['type' => 'paper']) }}" class="row mb-4 g-3 align-items-end">
                <div class="col-md-4">
            ...
            @if ($submissions->isEmpty()) 
                <p>{{ __('No papers submitted under this department') }}</p>
            @else
                ...
                <table class="table table-bordered border-dark-subtle table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('department.submissions.show',['type' => 'paper','id'=>$paper->id]) }}" class="btn btn-sm btn-primary">{{ __('View')}}</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
